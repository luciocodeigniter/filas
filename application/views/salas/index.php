...
<head>
    ...
    <title>Salas - Sistema de Senhas</title>
...
<body class="bg-light">
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-dark text-white">
                        <h5 class="mb-0"><i class="fas fa-door-open"></i> Cadastro de Sala</h5>
                    </div>
                    <div class="card-body">
                        <form id="formSala">
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="ativoSala" checked>
                                    <label class="form-check-label" for="ativoSala">Ativo</label>
                                </div>
                            </div>
    ...
    <script src="<?php echo base_url('public/'); ?>assets/js/salas.js"></script>
</body>
