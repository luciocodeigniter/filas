                        ...
                        <div class="row align-items-center">
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="selectMedico">
                                    <option value="1">João Silva - Clínica Geral</option>
                                    <option value="2">Maria Santos - Pediatria</option>
                                    <option value="3">Carlos Oliveira - Cardiologia</option>
                                    <option value="4">Ana Costa - Ortopedia</option>
                                </select>
                            </div>
                            <div class="col-md-3">
